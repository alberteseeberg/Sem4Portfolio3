...
#Creating models to check correlations 
glimmer(VerbalIQ~NonVerbalIQ, data=d3)
...
glimmer(VerbalIQ~SocialIQ, data=d3)
#Verbal IQ
mVIQ=map(
alist(
    VerbalIQ ~ dnorm( mu , sigma ),
...
precis(mSNVIQ, cor=T)
##### ÆNDRER I RÆKKEFØLGEN ÆNDRER RESULTATERNE... HVORFOR????


#Making model with scaled values


glimmer(ADOS~SocialIQ+VerbalIQ, scaledata)
